...
<link rel="stylesheet" href="css/bootstrap.min.css">
    ...
    ?>
            ...
            <?php
				$No = 1;
                $result = mysqli_query($conn, "SELECT Product_ID, Product_Name, Price, Pro_qty, Pro_image, Cat_Name, Shop_Name
                            FROM product a, category b, shop c
                            WHERE a.Cat_ID = b.Cat_ID and a.Shop_ID = c.Shop_ID ORDER BY ProDate DESC");
